...
const projectsData: Project[] = [
  ...
  },
  {
    ...
    imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnsfb36KgQOrHtjhz6Sw2pB4ho5YE2mnTKDA&s',
  ...
  },
  {
    ...
    imageUrl: 'https://dezyre.gumlet.io/images/blog/computer-vision-projects/Computer_Vision_Projects_ideas.webp?w=376&dpr=2.6',
...
const Projects: React.FC = () => {
  return (
    <Layout title="Projects" description="Explore our collection of AI projects for all skill levels.">
